...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <button style="width:120px; height:40px" name="masraffFiltrele" type="submit" class="btn btn-outline-info">Filtrele </button>
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
              ...
              <?php } else{
                       ...
                       $masrafcek = $db -> prepare("select * from masraflar inner join kategoriler on kategoriler.kategori_id = masraflar.kategori where masraf_zaman between ? and ? limit $limit, $sayfada");
                      $masrafcek -> execute(array($bastarih, $bittarih));
                    ...
                    while ($masrafsor = $masrafcek -> fetch(PDO::FETCH_ASSOC))
                     ...
                     {  ?>
                      ...
                      <td><?php echo $masrafsor['kategori_ad'] ?></td>
...
<?php   $s=0; ?>
<li class="page-item"><a class="page-link" href="masraflar.php?sayfa=<?php echo $s; ?>">İlk Sayfa</a></li>
<?php
...
if ($s==$sayfa) {?>
<li class="page-item active"><a class="page-link" href="masraflar.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
<?php } else {?>
<li>

<li class="page-item"><a class="page-link" href="masraflar.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
...
?>
<li class="page-item"><a class="page-link" href="masraflar.php?sayfa=<?php echo $s; ?>">Son Sayfa</a></li>
</ul>
</nav
              </div>
