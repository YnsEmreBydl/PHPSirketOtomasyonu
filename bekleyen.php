       ...
       <div class="row">
          <div class="col-md-12" style="margin:auto;">
            <div class="card">
                ...
                <h3 class="card-title">ÖDEME BEKLEYEN SİPARİŞLER</h3>
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
              ...
              <?php } else{
                       ...
                       $satiscek = $db -> prepare("select * from satislar inner join urunler on urunler.urun_id=satislar.urunsatis inner join personeller on personeller.personel_id=satislar.personel inner join cariler on cariler.cari_id=satislar.cari where siparis_durum=:siparis_durum limit $limit, $sayfada");
                      $satiscek -> execute(array('siparis_durum'=>0));
                    ...
                    while ($satissor = $satiscek -> fetch(PDO::FETCH_ASSOC))
                     ...
                     {  ?>
                      ...
                      <td><?php echo $satissor['satis_fiyat'] ?></td>
                      ...
                      <td>
                        ...
                        <?php } elseif($satissor['siparis_durum']==4) {?>
                          <div class="btn btn-danger btn-sm">İptal Edildi</div>
                        <?php } ?>
                      </td>
                      ...
                      <td><a href="duzenle.php?sayfa=satisduzenle&satis_id=<?php echo $satissor['satis_id'] ?>"><button type="submit" class="btn btn-warning">Düzenle</button></a></td>
                      <td><a href="islem.php?satis_id=<?php echo $satissor['satis_id'] ?>&satissil=del"> <button type="submit" class="btn btn-danger">Sil</button></a></td>
                    </tr>
...
<?php } ?>
  ...
  <ul style="float:right;" class="pagination p-3">
    <li class="page-item"><a class="page-link" href="satislar.php?sayfa=<?php echo $s--; ?>">Geri</a></li>
     <?php
    ...
    <li class="page-item active"><a class="page-link" href="satislar.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
     <?php } else {?>
      ...
      <li class="page-item"><a class="page-link" href="satislar.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
                          ...
                          ?>
    <li class="page-item"><a class="page-link" href="satislar.php?sayfa=<?php echo $s++; ?>">İleri</a></li>
  </ul>
</nav>
              </div>
...
<?php } ?>
 ...
 <?php if (@$_GET['satisdurum']=="satisdel") {?>
 <script type="text/javascript">
