...
<h3>POS CİHAZLARI</h3><hr>
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
             ...
             if ($toplam_icerik == 0) {?>
                    <div class="alert alert-warning col-12">AKTİF pos BULUNMAMAKTADIR</div>
              <?php } else{

                       $poscek = $db -> prepare("select * from pos limit $limit, $sayfada");
                      $poscek -> execute();
                ...
                <div class="card-footer">
                  ...
                  <div class="text-right">
                     <td>
                      ...
                      <td><a onClick="sil(<?php echo $possor['pos_id']?>)" type="submit" class="btn btn-danger btn-sm">Sil</a></td>
...
<?php   $s=0; ?>
<li class="page-item"><a class="page-link" href="pos.php?sayfa=<?php echo $s; ?>">İlk Sayfa</a></li>
<?php
...
?>
<li class="page-item"><a class="page-link" href="pos.php?sayfa=<?php echo $s; ?>">Son Sayfa</a></li>
</ul>
</nav>
  ...
  function sil(pos_id){
    Swal.fire({
      ...
      if (result.value) {
          ...
          window.location.href = 'islem.php?pos_id=' + pos_id;
