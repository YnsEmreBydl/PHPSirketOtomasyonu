       ...
       <div class="row">
         ...
         <div class="card-header ">
           ...
           <button type="submit" class="btn btn-danger" style="float:right; margin-right:5px">Ödenmemiş</button>
                ...
                <h3 class="card-title">ÖDEMESİ YAPILMIŞLAR</h3>
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                  ...
                  <?php } else{
                     ...
                     $odemecek -> execute(array('odeme_durum'=>1));
               ...
               <?php } ?>
                   ...
                   <td><a onClick="sil(<?php echo $odemesor['odeme_id']?>)" type="submit" class="btn btn-danger btn-sm">Sil</a></td>                   </tr>
