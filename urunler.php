       ...
       <div class="row">
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
              ...
              <?php } else{
                       ...
                       $uruncek = $db -> prepare("select * from urunler inner join urun_kategori on urun_kategori.kategori_id = urunler.kategori inner join markalar on markalar.marka_id = urunler.urun_marka order by urun_sira ASC limit $limit, $sayfada");
                      $uruncek -> execute();
                    ...
                    while ($urunsor = $uruncek -> fetch(PDO::FETCH_ASSOC))
                     ...
                     {  ?>
                      ...
                      <td style="width: 100px"><?php echo $urunsor['urun_fiyat'] ?> ₺</td>
                      <td><?php echo $urunsor['urun_stok'] ?></td>
                      <td><?php echo $urunsor['urun_sira'] ?></td>
                      ...
                      <td><a onClick="sil(<?php echo $urunsor['urun_id']?>)" type="submit" class="btn btn-danger btn-sm">Sil</a></td>
                    </tr>
...
<?php } ?>
                  ...
                  <ul style="float:right;" class="pagination p-3">
                    <?php     $s=0; ?>
                    <li class="page-item"><a class="page-link" href="urunler.php?sayfa=<?php echo $s; ?>">İlk Sayfa</a></li>
                     <?php
                    ...
                    <li class="page-item active"><a class="page-link" href="urunler.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
                     <?php } else {?>
                      ...
                      <li class="page-item"><a class="page-link" href="urunler.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
                                          ...
                                          ?>
                    <li class="page-item"><a class="page-link" href="urunler.php?sayfa=<?php echo $s; ?>">Son Sayfa</a></li>
                  </ul>
                </nav>
              </div>
  ...
  function sil(urun_id){
    Swal.fire({
      ...
      if (result.value) {
          ...
          window.location.href = 'islem.php?urun_id=' + urun_id;
