       ...
       <div class="row">
          <div class="col-md-12" style="margin:auto;">
            <div class="card">
                ...
                <h3 class="card-title">KARGODAKİ SİPARİŞLER</h3>
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
              ...
              <?php } else{
                      ...
                      $satiscek -> execute(array('siparis_durum'=>2));
...
<?php } ?>
  ...
  <ul style="float:right;" class="pagination p-3">
    <li class="page-item"><a class="page-link" href="kargo.php?sayfa=<?php echo $s--; ?>">Geri</a></li>
     <?php
    ...
    <li class="page-item active"><a class="page-link" href="kargo.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
     <?php } else {?>
      ...
      <li class="page-item"><a class="page-link" href="kargo.php?sayfa=<?php echo $s; ?>"><?php echo $s; ?></a></li>
                          ...
                          ?>
    <li class="page-item"><a class="page-link" href="kargo.php?sayfa=<?php echo $s++; ?>">İleri</a></li>
  </ul>
</nav>
              </div>
