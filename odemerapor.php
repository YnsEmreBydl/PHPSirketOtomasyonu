...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <button style="width:120px; height:40px" name="odemefFiltrele" type="submit" class="btn btn-outline-info">Filtrele </button>
                ...
                <table class="table table-responsive">
                  ...
                  <tbody>
                    ...
                    <?php
                       ...
                       $odemecek = $db -> prepare("select * from odemeler");
                      $odemecek -> execute();
        ...
        // toplam sayfa sayımızdan fazla yazılırsa en son sayfayı varsayalım.
                   ...
                   <?php } else{
                       ...
                       $odemecek = $db -> prepare("select * from odemeler  where odeme_zaman between ? and ? limit $limit, $sayfada");
                      $odemecek -> execute(array($bastarih,$bittarih));
                    ...
                    while ($odemesor = $odemecek -> fetch(PDO::FETCH_ASSOC))
                     ...
                     {  ?>
                      ...
                      <td  style="width: 100px"><?php echo $odemesor['odeme_baslik'] ?></td>
                     <td  style="width: 100px"><?php echo $odemesor['odeme_kime'] ?></td>

                      <td ><?php echo $odemesor['odeme_aciklama'] ?></td>
                      <td><?php echo $odemesor['odeme_tutar'] ?> ₺</td>
                      <td><?php echo $odemesor['odeme_alinan_zaman'] ?></td>
...
<?php   $s=0; ?>
<li class="page-item"><a class="page-link" href="odemeler.php?sayfa=<?php echo $s; ?>">İlk Sayfa</a></li>
<?php
...
?>
<li class="page-item"><a class="page-link" href="odemeler.php?sayfa=<?php echo $s; ?>">Son Sayfa</a></li>
</ul>
</nav>
              </div>
